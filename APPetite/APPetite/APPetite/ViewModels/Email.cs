...
namespace APPetite.ViewModels
{
    ...
    public class Email
    {
        ...
        private async Task<string> html_reset_password(string emailAddress)
        {
            ...
            var result = await FirebaseAccountHelper.UpdateUser(user.Username, user.Email, user.Password, randomThing);
        ...
        <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"" style=""max-width: 600px;"">
          ...
          <tr>
            <td align=""left"" bgcolor=""#ffffff"" style=""padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"">
              <p style=""margin: 0;"">If you've lost your password or wish to reset it, here is a new password for you.</p>
            </td>
          </tr>
          <!-- end copy -->
                    ...
                    <table border=""0"" cellpadding=""0"" cellspacing=""0"">
                      <tr>
                        <td align=""center"" bgcolor=""#1a82e2"" style=""border-radius: 6px;"">
                          <a href="""" target=""_blank"" style=""display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;"">" + randomThing + @"</a>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td align=""left"" bgcolor=""#ffffff"" style=""padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf"">
              <p style=""margin: 0;"">Cheers,<br> APPetite</p>
            </td>
          </tr>
          <!-- end copy -->
